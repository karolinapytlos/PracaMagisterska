...
class SmsSpamCollectionDataset(DatasetLoader):
    ...
    @staticmethod
    def load_data (data_type, clear_data, data_sample=False, n_samples=0, n_samples_for_class=False, name='Sms spam'):
        data = []
        ...
        if data_type == Type.text:
            X, y = SmsSpamCollectionDataset.get_text_data(data)
