...
from . import EcommerceReviewsDataset
from ..DataType import Type

class EcommerceReviews (Initiate):
    def __init__(self, n_trees, n_object_pairs, similarity_function, test_dataset_size,
                 dataset_type=EcommerceReviewsDataset, data_type=Type.vector, clear_data=True, data_sample=True, n_samples=50, n_samples_for_class=True):
        print(" \n---- E-COMMERCE REVIEWS ---- ")
